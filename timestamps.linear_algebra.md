...
- [ШАД prep 2021 — линал 03](#шад-prep-2021--линал-04)
...
3:12:18 Скелетное разложение.  
TODO: Скелетное разложение = ранговая факторизация?  
3:22:14 Задача: Подпространство задано матрицей, { y | Ay = 0 }, надо найти базис. Это называется ФСР — фундаментальная система решений.  
